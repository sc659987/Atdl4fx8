...
import com.three60t.ui.abs.AbstractFixAtdlUi;
import com.three60t.ui.common.UiElementAbstractFactory;
import com.three60t.ui.common.element.FixDropDownListUiElement;
import com.three60t.ui.common.element.FixLayoutUiElement;
import com.three60t.ui.fx8.validator.FixParameterValidatorImpl;
import com.three60t.ui.validator.FixParameterValidator;
import com.three60t.ui.validator.FixStrategyEditValidator;
import com.three60t.wire.WireValueManipulator;
    ...
    public Pane createUi() {
        if (getStrategies() != null) {
            ...
            if (getSelectedStrategy() != null) {
                this.fixStrategyEditValidator = new com.three60t.ui.fx8.validator.FixStrategyEditValidator(
